...
class ResNet50Fc(nn.Module):
  def __init__(self):
    ...
    self.avgpool = model_resnet50.avgpool#nn.AdaptiveAvgPool2d((1, 1))
...
# class Resnet18_AV(nn.Module):
#     def __init__(self):
#         super(Resnet18_AV, self).__init__()
#         self.aud = audio_resnet.resnet18_auditory()
#         self.vis = visual_resnet.resnet18_visual()
#         self.len = self.aud.size()[1] + self.vis.size()[1]

#     def forward(self,x,y):
#         feature_1 = self.aud(x)
#         feature_2 = self.vis(y)
#         vid_feat = torch.sum(feature_2, 0, keepdim = True)
#         vid_feat /= feature_2.size()[0]
#         feature = torch.cat((feature_1, vid_feat), 1)
#         return feature

#     def output_num(self):
#         return self.len

network_dict = {"AlexNet":AlexNetFc, "ResNet18":ResNet18Fc, "ResNet34":ResNet34Fc, "ResNet50":ResNet50Fc, "ResNet101":ResNet101Fc, "ResNet152":ResNet152Fc}#, "Resnet18_AV": Resnet18_AV}
